...
// enpoints
app.get('/orbit/disconnect', async function (req, res) {
    try {
...
app.post('/orbit/connect', async function (req, res) {
    try {
...
app.get('/orbit/clean', async function (req, res) {
    try {
...
app.get('/orbit/getaddress', async function (req, res) {
    try {
...
app.get('/orbit/getmultiaddress', async function (req, res) {
    try {
...
app.get('/orbit/getalldata', async function (req, res) {
    try {
...
app.post('/orbit/setbroadcast', async function (req, res) {
    try {
...
app.post('/orbit/getdata', async function (req, res) {
    try {
...
app.post('/orbit/storedata', async function (req, res) {
    try {
        logger.debug('==================== STORE DATA INTO IPFS ==================');

        let message = storedata.storeData();
